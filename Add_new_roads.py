...
class Add_new_roads:
    ...
    def clickMethod_2(self):
        ...
        #self.dlg.listWidget.addItem(str(self.list_street))
        vl = QgsVectorLayer('LineString?crs=epsg:4326&field=id:integer&field=street_id:integer&field=temporary:integer&field=special_use:integer&field=exclude:integer&field=moduser:integer&field=objid:integer', "test", "memory")
        pr = vl.dataProvider()
        ...
        for element in it:
            ...
            for y in attr_street:
                feat.setAttribute(1, y)
            #self.dlg.listWidget.addItems([str(attr_street)])
